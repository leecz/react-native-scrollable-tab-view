...
const ScrollableTabBar = createReactClass({
  ...
  updateTabUnderline(position, pageOffset, tabCount, underlineWidth) {
    let tabMeasure = this._tabsMeasurements[position];
    underlineWidth = underlineWidth || tabMeasure.width;
    let offset = tabMeasure.width / 2 - underlineWidth / 2;
    ...
    if (position < tabCount - 1) {
      ...
      this.state._leftTabUnderline.setValue(newLineLeft + offset);
      this.state._widthTabUnderline.setValue(newLineRight - newLineLeft);
    } else {
      this.state._leftTabUnderline.setValue(lineLeft + offset);
